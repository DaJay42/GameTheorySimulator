...
public class GameMain {
	...
	public static Class<? extends GameTourney> tourney = EconomicModel.class;
	public static String[] tourneyArgs = {};
	public static Class<? extends GameRuleSet> ruleSet = AxelrodPrisoners.class;
	public static ArrayList<Class<? extends GameStrategy>> listStrategies;
	...
	**/
	public static void main(String[] args){
		 ...
		 */
		try{
		listStrategies = new ArrayList<Class<? extends GameStrategy>>();
